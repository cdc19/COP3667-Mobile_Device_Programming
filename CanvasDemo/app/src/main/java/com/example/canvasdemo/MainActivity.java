...
public class MainActivity extends AppCompatActivity {
    ...
    // Here are all the objects (instances) of classes taht we need to do some drawing
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setContentView removed to align with Chapter 20 app creation instructions.
        // setContentView(R.layout.activity_main);

        // Initialize all the objects ready for drawing. We will do this inside the onCreate method.
        ...
        // Initialize the Canvase and associate it with the Bitmap to draw on

package com.example.multidimensionalarray;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //We declare and allocate in separate stages for clarity but we don't have to
        String[][] countriesAndCities;

        //Here we have a 2 dimensional array, specifically 5 arrays with 2 elements each
        //Perfect for 5 "What's the capital city" questions
        countriesAndCities = new String[5][2];

        /* Now we load the questions and answers into our arrays. Feel free to do this with less questions to save typing
        ...
        /* Now we know that the country is stored at element 0, and the matching capital at element 1. Here are two variables that reflect this */
        ...
        for(int i = 0; i < 3; i++){
            ...
            // and ask the question and in this case just give the answer for the sake of brevity
